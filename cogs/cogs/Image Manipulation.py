...
class ImageManipulation(commands.Cog):
    ...
    async def Obese(self, ctx, member : discord.Member=None):
        ...
        '''
    @commands.command()
    async def bird(self, ctx, member : discord.Member=None):
        if member == None:
            avatar = ctx.author.avatar_url_as(format=None,static_format='jpg',size=1024)
        ...
        im1 = Image.open('./Images/bird.jpg')
        img_path = './Images/Avatar.jpg'
        img = Image.open(img_path)
        width, height = img.size
        asp_rat = width/height
        ...
        if (new_rat == asp_rat):
            ...
            new_height = round(new_width / asp_rat)
            img = img.resize((new_width, new_height), Image.ANTIALIAS)
        img.save('./Images/Avatar.jpg')

        back_im = im1.copy()
        mrl = Image.open('./Images/Avatar.jpg')
        back_im.paste(mrl, (590, 11))
    ...
    async def frog(self, ctx, member : discord.Member=None):
        ...
        im1 = Image.open('./Images/frog.jpg')
        img_path = './Images/Avatar.jpg'
        img = Image.open(img_path)
        width, height = img.size
        asp_rat = width/height
        ...
        mrl = Image.open('./Images/Avatar.jpg')
        back_im.paste(mrl, (590, 11))
        back_im.save('./Images/Frog0.jpg', quality=95)
        await ctx.send(file=discord.File('./Images/Frog0.jpg'))
        '''
            End of Something
            NU NU NU
        '''
    ...
    async def wanted(self, ctx, user: discord.Member = None):
        ...
        pfp = pfp.resize((128,208))
        wanted.paste(pfp, (86,204))
